...
public struct PreferencesPage: Widget {
    ...
    public var debugTreeParameters: [(String, value: CustomStringConvertible)] {
        [("description", value: "\(description)"), ("iconName", value: "\(iconName)"), ("name", value: "\(name)"), ("title", value: "\(title)"), ("useUnderline", value: "\(useUnderline)"), ("app", value: "\(app)"), ("window", value: "\(window)")]
    }
    ...
    public var debugTreeContent: [(String, body: Body)] {
        ...
        content.append(("child", body: self.child()))
        return content
    }
