...
public struct EntryRow: Widget {
    ...
    public var debugTreeParameters: [(String, value: CustomStringConvertible)] {
        [("activatesDefault", value: "\(activatesDefault)"), ("enableEmojiCompletion", value: "\(enableEmojiCompletion)"), ("showApplyButton", value: "\(showApplyButton)"), ("textLength", value: "\(textLength)"), ("title", value: "\(title)"), ("titleSelectable", value: "\(titleSelectable)"), ("useMarkup", value: "\(useMarkup)"), ("useUnderline", value: "\(useUnderline)"), ("apply", value: "\(apply)"), ("entryActivated", value: "\(entryActivated)"), ("app", value: "\(app)"), ("window", value: "\(window)")]
    }
