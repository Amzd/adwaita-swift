...
public struct Popover: Widget {
    ...
    public var debugTreeParameters: [(String, value: CustomStringConvertible)] {
        [("accessibleRole", value: "\(accessibleRole)"), ("autohide", value: "\(autohide)"), ("cascadePopdown", value: "\(cascadePopdown)"), ("hasArrow", value: "\(hasArrow)"), ("mnemonicsVisible", value: "\(mnemonicsVisible)"), ("activateDefault", value: "\(activateDefault)"), ("closed", value: "\(closed)"), ("app", value: "\(app)"), ("window", value: "\(window)")]
    }

    /// The debug tree's content.
    public var debugTreeContent: [(String, body: Body)] {
        var content: [(String, body: Body)] = [("child", body: self.child?() ?? []), ("defaultWidget", body: self.defaultWidget?() ?? []),]
