...
public struct SearchBar: Widget {
    ...
    public var debugTreeParameters: [(String, value: CustomStringConvertible)] {
        [("accessibleRole", value: "\(accessibleRole)"), ("searchModeEnabled", value: "\(searchModeEnabled)"), ("showCloseButton", value: "\(showCloseButton)"), ("app", value: "\(app)"), ("window", value: "\(window)")]
    }

    /// The debug tree's content.
    public var debugTreeContent: [(String, body: Body)] {
        var content: [(String, body: Body)] = [("child", body: self.child?() ?? []), ("keyCaptureWidget", body: self.keyCaptureWidget?() ?? []),]
