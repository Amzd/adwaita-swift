...
public struct ProgressBar: Widget {
    ...
    public var debugTreeParameters: [(String, value: CustomStringConvertible)] {
        [("accessibleRole", value: "\(accessibleRole)"), ("fraction", value: "\(fraction)"), ("inverted", value: "\(inverted)"), ("pulseStep", value: "\(pulseStep)"), ("showText", value: "\(showText)"), ("text", value: "\(text)"), ("app", value: "\(app)"), ("window", value: "\(window)")]
    }
